...
export const FAQ_SCHEMA = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Мы реализуем концепцию Security-by-Design. Безопасность закладывается на уровне архитектуры: изоляция сервисов, аудит кода на уязвимости OWASP Top 10, шифрование данных и защита от DDoS-атак на сетевом уровне. Платформа проходит стресс-тестирование перед запуском."
      }
    }
  ]
};
